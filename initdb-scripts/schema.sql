...
-- Optional: IIndex the 'beacons' JSONB column to improve query performance on JSON data.
...
-- Optional: Convert table into a TimescaleDB hypertable for optimized performance.
