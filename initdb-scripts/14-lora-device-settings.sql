...
CREATE TABLE parking.lora_device_settings (
...
BEFORE UPDATE ON parking.lora_device_settings
FOR EACH ROW
EXECUTE FUNCTION update_timestamp();

-- Index for device lookups.
CREATE INDEX idx_lora_device_settings_device_id ON parking.lora_device_settings (device_id);
